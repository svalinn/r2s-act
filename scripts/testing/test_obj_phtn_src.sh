...
cd $TEST_DIR
rm test_gammas1 test_gammas2 test_gammas3 test_gammas4 test_sdef1 test_sdef2 matFracsTest.h5m -f
...
/filespace/people/r/relson/DAG-MCNP/5.1.51/trunk/Source/src/mcnp5 i=simplebox-3_src

# Cleanup
echo
echo All tests are done. Now removing created files.
rm test_gammas1 test_gammas2 test_gammas3 test_gammas4 test_sdef1 test_sdef2 xmatFracsTest.h5m -f
